  ...
  final List<Map<String, dynamic>> _settings = [
...

    {
      ...
      "settings": [
        ...
        SettingCardModel(
          ...
          iconPath: "assets/3d/house_3d.png",
        ),
      ],
    },

    {
      ...
      "settings": [
        SettingCardModel(
          label: "Socials",
          iconPath: "assets/3d/settings/socials_3d.png",
        ),
        SettingCardModel(
          label: "Help Center",
        ...
        SettingCardModel(
          ...
          iconPath: "assets/3d/settings/invite_3d.png",
        ),
        SettingCardModel(
          label: "Rate the App",
...

    {
      ...
      "settings": [
        ...
        SettingCardModel(
          ...
          iconPath: "assets/3d/settings/trash_3d.png",
        ),
      ],
    },
  ];
    ...
    return SliverPadding(
      ...
      sliver: SliverMainAxisGroup(
        slivers: [
          ...
          //                   showCribLynkSnackbar(context, "Coming Soon");
          //                 },
          //               );
          //             },
          //             childCount:
          //                 (_settings.last['settings'] as List<SettingCardModel>)
          //                     .length,
          //           ),
          //         ),
          //       ),
